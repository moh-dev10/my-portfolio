    ...
    resources: {
      ...
      ar: {
        translation: {
          ...
          hero_desc: "أبني مواقع عالية الأداء مع التركيز على تصميم حديث وسهل الاستخدام.",
      ...
      fr: {
        translation: {
          ...
          hero_desc: " Je crée des sites web à haute performance avec un focus sur l'UI/UX moderne.",
